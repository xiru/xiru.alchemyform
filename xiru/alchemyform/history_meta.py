...
# Basede on https://bitbucket.org/sqlalchemy/sqlalchemy/src/de4eb56fb6c8/examples/versioning/history_meta.py
# More information at http://www.sqlalchemy.org/docs/orm/examples.html?highlight=version#versioned-objects
...
from xiru.alchemyform.config import DISABLE_VERSIONS
...
def _history_mapper(local_mapper):
    ...
    if not super_history_mapper:
        ...
        cls.version_date = Column('version_date', DateTime, default=datetime.datetime.now(), nullable=False)
...
def create_version(obj, session, deleted = False):
    ...
    for om, hm in zip(obj_mapper.iterate_to_root(), history_mapper.iterate_to_root()):
        ...
        for hist_col in hm.local_table.c:
            if hist_col.key in ('version', 'version_date'):
                continue
...
if DISABLE_VERSIONS:
    ZopeVersionedExtension = ZopeTransactionExtension
else:
    class ZopeVersionedExtension(ZopeTransactionExtension, VersionedListener):
        pass
